...
const METRICS = {
  ...
  overdue_installment_patient_count: 'overdue_installment_patient_count',
  overdue_installment_patient_list: 'overdue_installment_patient_list',
  overdue_installment_ratio: 'overdue_installment_ratio',
  doctor_overdue_installment_ratio: 'doctor_overdue_installment_ratio',
...
const INTENT_HELP = {
  [INTENTS.finance_summary]:
    'Klinik geneli finans özeti. Metric: revenue_amount, collection_amount, pending_collection_amount, outstanding_balance_amount, overdue_receivables_amount, overdue_installment_amount, overdue_installment_count, overdue_installment_patient_count, overdue_installment_patient_list, overdue_installment_ratio, doctor_overdue_installment_ratio, overdue_patient_list, avg_invoice_amount, avg_payment_amount, discount_total_amount, expense_total_amount.',
...
const METRIC_HELP = {
  ...
  [METRICS.overdue_installment_amount]: 'Vadesi geçmiş taksit toplam tutarı',
  [METRICS.overdue_installment_count]: 'Vadesi geçmiş taksit sayısı',
  [METRICS.overdue_installment_patient_count]: 'Vadesi geçmiş taksiti olan hasta sayısı',
  [METRICS.overdue_installment_patient_list]: 'Vadesi geçmiş taksiti olan hasta listesi',
  [METRICS.overdue_installment_ratio]: 'Vadesi geçmiş taksit oranı',
  [METRICS.doctor_overdue_installment_ratio]: 'Doktor bazlı vadesi geçmiş taksit oranı',
